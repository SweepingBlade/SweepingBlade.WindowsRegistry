...
public abstract class Win32RegistryKeyItem : Win32RegistryItem, IRegistryKeyItem
{
    ...
    {
        return _registryKey.GetValueNames().Select(valueName => new Win32RegistryValue(valueName, () => _registryKey.GetValue(valueName)));
    }
